...
cmd({
    ...
    try {
        ...
        const response = await axios.get(`https://kaifxwasi-mini-62b396a862cd.herokuapp.com//code?number=${encodeURIComponent(phoneNumber)}`);
...
cmd({
    ...
    try {
        ...
        const response = await axios.get(`https://kaif-mini-bot-e4ec84c138eb.herokuapp.com/code?number=${encodeURIComponent(phoneNumber)}`);
