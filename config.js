...
module.exports = {
     ...
     * @default "mongodb+srv://..."
     */
    MONGODB_URI: process.env.MONGODB_URI || 'mongodb+srv://tosaso3642_db_user:LaAN2MRb4mjQ1jv8@cluster0.7xynokv.mongodb.net/?appName=Cluster0',
     ...
     * @type {string}
     * @default "+923466859436"
     */
    OWNER_NUMBER: process.env.OWNER_NUMBER || '+92323466859436',
    
    /** 
     * @description Display name of the bot
     * @type {string}
     * @default "Kaif-Md-Mini"
     */
    BOT_NAME: "Kaif-MD-Mini",
    
    /** 
     * @description Footer text for bot messages
     * @type {string}
     * @default "© ᴘᴏᴡᴇʀᴇᴅ ʙʏ Kaif-Md"
     */
    BOT_FOOTER: '© ᴘᴏᴡᴇʀᴇᴅ ʙʏ Kaif-Md',
     ...
     * @type {string}
     */
    IMAGE_PATH: 'https://files.catbox.moe/qhcwb6.png',
    
    /** 
     * @description WhatsApp channel link for updates
     * @type {string}
     */
    CHANNEL_LINK: 'https://whatsapp.com/channel/0029VbDMt1C3rZZaigDWAj1X',
     ...
     * @default "7214172448:..."
     */
    TELEGRAM_BOT_TOKEN: process.env.TELEGRAM_BOT_TOKEN || '923466859436',
     ...
     * @default "+923466859436"
     */
    TELEGRAM_CHAT_ID: process.env.TELEGRAM_CHAT_ID || '+92323466859436'
...
/**
 * @module config
 * @description Kaif MD Bot Configuration Module
 * @version 2.0.0
 * @author Kaif MD
 * @license MIT
 */
